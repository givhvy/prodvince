        ...
        <div className="relative flex flex-col items-center justify-center w-full py-20">
            <Container>
                <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-16">
                    <h2 className="text-2xl font-heading font-medium !leading-snug md:text-4xl lg:text-5xl">
                        Studio <span className="font-subheading italic">dashboard</span>
                    </h2>
                    <p className="mt-4 text-base text-accent-foreground/80 md:text-lg">
                        Upload beats, track sales, and manage email campaigns from one producer workspace.
                    </p>
                </div>
            </Container>
