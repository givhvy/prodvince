            ...
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    <h2 className="mt-6 font-heading text-2xl font-medium !leading-snug md:text-4xl lg:text-5xl">
                        Beat commerce made <br /> <span className="font-subheading italic">simple</span>
                    </h2>
                    <p className="mt-6 text-base text-accent-foreground/80 md:text-lg">
                        Marketplace discovery, producer Studio, email marketing, and live Whop payments in one platform.
                    </p>
                </div>
            </Container>
